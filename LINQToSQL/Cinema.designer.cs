...
namespace LINQToSQL
{
    ...
    partial void OnDurataChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Genere", DbType="VarChar(225) NOT NULL", CanBeNull=false)]
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnNPostiChanging(int value);
    partial void OnNPostiChanged();
    ...
    partial void OnIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_NPosti", DbType="Int NOT NULL")]
		public int NPosti
		{
			get
			{
			...
			set
			{
				if ((this._NPosti != value))
				{
					this.OnNPostiChanging(value);
					this.SendPropertyChanging();
					this._NPosti = value;
					this.SendPropertyChanged("NPosti");
					this.OnNPostiChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Mail", DbType="NVarChar(225) NOT NULL", CanBeNull=false)]
		public string Mail
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Programmazione_Prenotazione", Storage="_Programmazione", ThisKey="ProgramID", OtherKey="ID", IsForeignKey=true)]
    ...
    partial void OnPosti_DisponibiliChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Programmazione_Prenotazione", Storage="_Prenotaziones", ThisKey="ID", OtherKey="ProgramID")]
